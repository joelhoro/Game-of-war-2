...
def printInstructions():
    print("You and the computer will pick random cards from 1 to 10 and whoever gets the highest card wins, if it is a draw, the computer wins: the house always wins ;)")
